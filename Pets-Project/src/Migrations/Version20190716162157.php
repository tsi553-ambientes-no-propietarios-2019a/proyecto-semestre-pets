 ...
 */
final class Version20190716162157 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE anfitrion (id INT AUTO_INCREMENT NOT NULL, id_anfitrion_id INT NOT NULL, cuenta VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6DE0F10DE0F511F8 (id_anfitrion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

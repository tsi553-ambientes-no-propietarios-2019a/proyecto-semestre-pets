 ...
 */
final class Version20190723201400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cobro_anf (id INT AUTO_INCREMENT NOT NULL, id_transaccion_id INT NOT NULL, user_id INT NOT NULL, comision VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4E5936E5B0DFD449 (id_transaccion_id), UNIQUE INDEX UNIQ_4E5936E5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE paquete (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tipo_masc VARCHAR(255) NOT NULL, alimento VARCHAR(255) NOT NULL, aseo_masc VARCHAR(255) NOT NULL, precio VARCHAR(255) NOT NULL, INDEX IDX_12686A95A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
